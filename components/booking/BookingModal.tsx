...
export default function BookingModal({ open, onClose }: BookingModalProps) {
  return (
    ...
    >
      <Paragraph disableAnimation className="text-chocolate pb-6 text-center">
        Свяжитесь с нами удобным способом
      </Paragraph>

      <div className="grid grid-cols-2 gap-6 text-center">
        <div>
          <Paragraph disableAnimation className="text-gray pb-2">
            По телефону
          </Paragraph>
          <a href={PHONE_HREF}>
            <H3Title className="text-terracotta hover:text-terracotta-hover px-9 py-3 whitespace-nowrap">
              {PHONE}
            </H3Title>
          </a>
        </div>
        ...
        <div>
          ...
          <div className="flex justify-center gap-4">
            ...
            />
            <Max href="https://max.ru/ohmumbai" fill={GREEN} />
            <WhatsApp href="https://wa.me/78123140340" fill={GREEN} />
          </div>
        </div>
      </div>
    </Modal>
