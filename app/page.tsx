    ...
    <main>
      <section className="relative flex h-245 w-full">
        ...
        >
          <div className="flex flex-col text-center">
            <H3Title className="pb-4 text-white" delay={0.2}>
              Санкт-Петербург
            </H3Title>
            <H1Title className="pb-12 text-white" delay={0.4}>
      ...
      <Section className="pt-12 pb-30">
        ...
        <div className="col-span-6">
          <Paragraph className="text-gray pb-2" delay={0.1}>ресторан</Paragraph>

          <Paragraph className="pb-8" delay={0.2}>
          ...
          <H3Title className="pb-4" delay={0.3}>
        ...
        <AnimatedImage className="col-span-12 mb-30 h-197 rounded-sm" />

        <div className="col-span-6">
          <H2Title className="pb-2" delay={0}>Традиционная индийская кухня</H2Title>
          <Paragraph delay={0.1}>
        ...
        <div className="col-span-6">
          <Paragraph className="text-gray pb-2" delay={0.1}>Шеф-повар</Paragraph>
          <H3Title className="pb-4" delay={0.2}>Манджил</H3Title>
          <Paragraph delay={0.3}>
